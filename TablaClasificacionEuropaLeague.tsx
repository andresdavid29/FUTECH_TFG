...
import { teamLogosEuropa } from "../assets/teamLogosEuropa";
...
const TablaClasificacionEuropaLeague: React.FC = () => {
      ...
      <main className="flex-grow content-spacing flex justify-center items-start py-6">
        <div className="w-[96%] max-w-sm px-2">
          <header className="flex items-center justify-between mb-4">
            <h1 className="text-xl font-bold">Clasificación Europa League</h1>
            <img src={leagueLogos.europa} alt="Logo Europa League" style={{ height: "80px" }} />
          </header>
          ...
          {equipos.map((equipo, idx) => {
            ...
            const teamName = parts.slice(1).join(' ') || parts[0];
            const logoKey = teamLogosEuropa[teamName] ? teamName : equipo.Equipo;
            const logoSrc = teamLogosEuropa[logoKey] || '/logos/placeholder.png';
...
export default TablaClasificacionEuropaLeague;
